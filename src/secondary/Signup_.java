...
public class Signup_ extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(input_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(input_panelLayout.createSequentialGroup()
                        .addGroup(input_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(dob_date, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(52, 52, 52)
                        .addGroup(input_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        input_panelLayout.setVerticalGroup(
            ...
            .addGroup(input_panelLayout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addGroup(input_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(address_textfield, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
                    .addComponent(dob_date, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(2, 2, 2)
                .addGroup(input_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void create_accountActionPerformed(java.awt.event.ActionEvent evt) {
      boolean isInputValid = true;
      

        String fString = firstName_textfield.getText();
        String lString = lastName_textfield.getText();
        SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd");
        String dString = dateformat.format(dob_date.getDate());
        String aString = address_textfield.getText();
        String eString = email_textfield.getText();
        String pString = phoneNumber_textfield.getText();
        String pwString = String.valueOf(password_passwordfield.getPassword());
        String rpwString = String.valueOf(retype_password_passwordfield.getPassword());

        PreparedStatement ps;
        String query = "INSERT INTO `users`(`u_fname`, `u_lname`, `u_email`, `u_pass`, `u_bdate`, `u_address`) VALUES (?,?,?,?,?,?)";

        try {
            ps = MyConnection.getConnection().prepareStatement(query);
            ps.setString(1, fString);
            ps.setString(2, lString);
            ps.setString(3, eString);
            ps.setString(4, pwString);
            ps.setString(5, dString);
            ps.setString(6, aString);
    ...
    if (ps.executeUpdate() > 0) {
        ...
        JOptionPane.showMessageDialog(null, "Failed to create your account!", "Error", JOptionPane.ERROR_MESSAGE);
    }
            }   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Signup_.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
